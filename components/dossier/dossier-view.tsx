...
export function DossierView({
  ...
  return (
    <div
       ...
       */
      className="mx-auto grid max-w-[var(--container-page)] grid-cols-1 gap-10 px-5 py-8 md:px-8 xl:grid-cols-[190px_minmax(0,1fr)] xl:gap-14 print:block print:max-w-none"
    >
      <ContentsNav />
